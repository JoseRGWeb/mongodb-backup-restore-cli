...
var retentionServiceLogger = loggerFactory.CreateLogger<RetentionService>();
var retentionService = new RetentionService(retentionServiceLogger);
...
static Command CreateBackupCommand(IBackupService backupService, ILoggerFactory loggerFactory)
{
    ...
    var retentionDaysOption = new Option<int?>(
        name: "--retention-days",
        description: "Número de días de retención. Los backups más antiguos serán eliminados automáticamente",
        getDefaultValue: () =>
        {
